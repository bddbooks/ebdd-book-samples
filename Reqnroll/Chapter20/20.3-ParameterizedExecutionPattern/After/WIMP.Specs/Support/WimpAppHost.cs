...
public class WimpAppHost(IDataRepository dataRepository, IPaymentGateway? customPaymentGateway) : WebApplicationFactory<Program>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(diConfig =>
            diConfig.AddSingleton(dataRepository));
        if (customPaymentGateway != null)
        {
            builder.ConfigureServices(diConfig =>
                diConfig.AddSingleton(customPaymentGateway));
        }
    }
}
