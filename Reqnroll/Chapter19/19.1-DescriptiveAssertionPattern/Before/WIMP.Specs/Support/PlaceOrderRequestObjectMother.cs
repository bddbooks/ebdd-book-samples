...
public class PlaceOrderRequestObjectMother
{
    ...
    private DateTimeOffset? placingTime = null;
    ...
    {
        return new(items.ToArray(), email, deliveryAddress, PlacingTime: placingTime);
    }
    ...
    public PlaceOrderRequestObjectMother WithPlacingTime(TimeSpan time)
    {
        placingTime = DateTimeOffset.Now.WithTime(time);
        return this;
    }
}
